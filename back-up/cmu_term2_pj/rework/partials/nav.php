    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/hotels.php">Destinations</a>
                </li>
                <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php if ($_SESSION['user_role'] === 'hotel_owner') : ?>
                                <li><a class="dropdown-item" href="/manage-hotel.php">Manage Hotel</a></li>
                ...
                <?php else : ?>
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'login.php' ? 'active' : ''; ?>" href="/views/login.php">Login</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
